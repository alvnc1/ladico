...
function ResultsIntermedioContent() {
  ...
  const handleNextLevel = () => {
    ...
    router.push(`/exercises/comp-4-3/${nextLevel}/ej1`);
  }
                ...
                <div className="mt-8">
                  ...
                  >
                    <div className="flex items-center gap-2 text-gray-800">
                      ...
                      <span>Ejercicio 1: Vincular amenazas con medidas preventivas (drag &amp; drop)</span>
                    </div>
                  ...
                  >
                    <div className="flex items-center gap-2 text-gray-800">
                      ...
                      <span>Ejercicio 2: Ordenamiento por criterio (inclusión, bienestar, viabilidad)</span>
                    </div>
                  ...
                  >
                    <div className="flex items-center gap-2 text-gray-800">
                      ...
                      <span>Ejercicio 3: Ordenamiento por criterio (consolidación de nivel)</span>
                    </div>
