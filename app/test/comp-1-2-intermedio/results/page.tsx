...
function ResultsIntermedioContent() {
  ...
  const handleRetry = () => router.push("/exercises/comp-1-2/intermedio/ej1")
                ...
                <div className="mt-8">
                  ...
                  >
                    <div className="flex items-center gap-2 text-gray-800">
                      ...
                      <span>Ejercicio 1: Clasificar sitios web</span>
                    </div>
                  ...
                  >
                    <div className="flex items-center gap-2 text-gray-800">
                      ...
                      <span>Ejercicio 2: Montaje Fotográfico</span>
                    </div>
                  ...
                  >
                    <div className="flex items-center gap-2 text-gray-800">
                      ...
                      <span>Ejercicio 3: Gráfico de equipaje por tipo</span>
                    </div>
